...
import  { useCart }  from '../Shop/Cartcontext'; // Use the custom hook for cart context
import Modal from '../../Modal';  // Import the Modal component
import SuccessBox from '../../components/Successbox/Sucsess'; // Import the SuccessBox component

export default function Ram({ showSuccessMessage }) {
  ...
  // Update filtered items to include a search based on color
  ...
  return (
    <>
      <div className="title flex" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold', marginTop: '30px', fontFamily: 'cursive' }}>
        <h2 className='shop-heading'>Ramdan Occasion</h2>
      </div>
