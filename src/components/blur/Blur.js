...
export default function Blur() {
  return (
    <div className='blur'>
      <p style={{textAlign:'center'}}>We provide a special place where you can buy beautiful flowers online! You can send flowers to Any place for any special occasion, like a birthday, anniversary, or just to say “I love you.” We have many different types of flowers, like roses, daisies, and sunflowers. You can even choose the colors you want and have them delivered right to your doorstep. Online florists in Hurghada are a convenient and easy way to bring a little happiness into someone’s day.</p>
      ...
      <div className='data' >
        ...
        <Link to='/occasion' style={{marginLeft:'55px',
    /* margin-top: 10px; */
    position:'relative',
